...
const viewImage = (url, fund) => {
  modalImg.value = {
    src: resolveMediaUrl(url),
    alt: fund?.reason || 'Ảnh minh chứng giao dịch quỹ',
    filename: `fcdbb-fund-${fund?.id || 'proof'}`,
  };
};
