<template>
  <div class="flex items-center justify-center min-h-[80vh] w-full">
    <div class="glass-panel w-full max-w-md p-8 text-center fade-up">
      <div class="badge-crest mx-auto mb-5">⚽</div>
      <p class="section-eyebrow mb-1">FC Đại Bàng Bình Dương</p>
      <h2 class="text-3xl font-display font-bold mb-8 text-white">Đăng Nhập</h2>
...
const login = async () => {
  ...
  console.log("🔗 Đang kết nối tới Backend tại:", API);
  try {
